                                        ...
                                        <div className="card">
                                            <div className="form ">
                                                ...
                                                <div className="form-div">
                                                    ...
                                                    />
                                                    {formik.errors.emailConfirmation && formik.touched.emailConfirmation ? (
                                                        <span className="input-error-msg">
                                                ...
                                                <div className="row">
                                                    <div className="col-md-6">
                                                        <div className="form-div">
                                                            ...
                                                            {formik.errors.country_of_residence && formik.touched.country_of_residence ? (
                                                                <span className="input-error-msg">
                                                    ...
                                                    <div className="col-md-6">
                                                        <div className="form-div">
                                                            ...
                                                            <select
                                                                name="num_of_homes"
                                                                id="num_of_homes"
                                                                className={`form-control ${formik.errors.num_of_homes ? "invalidInput" : ""
                                                                    } `}
                                                                onChange={formik.handleChange}
                                                                onBlur={formik.handleBlur}
                                                            ...
                                                            {formik.errors.num_of_homes && formik.touched.num_of_homes ? (
                                                                <span className="input-error-msg">
                                                    ...
                                                    {Array(Number(formik?.values?.num_of_homes)).fill().map((opt, index) => (
                                                        <div className="col-md-6" key={index}>
                                                            <div className="form-div">
                                                                ...
                                                                <input
                                                                    type="text"
                                                                    name={`${counts[index]?.toLowerCase()}_home_country`}
                                                                    id={`${counts[index]?.toLowerCase()}_home_country`}
                                                                    className={`form-control ${formik.errors[`${counts[index]?.toLowerCase()}_home_country`] && formik.touched[`${counts[index]?.toLowerCase()}_home_country`] ? "invalidInput" : ""
                                                                        } `}
                                                                    placeholder="Enter country"
                                                                    onChange={formik.handleChange}
                                                                    onBlur={formik.handleBlur}
                                                                    value={formik.values[`${counts[index]?.toLowerCase()}_home_country`]}
                                                                />
                                                                {formik.errors[`${counts[index]?.toLowerCase()}_home_country`] && formik.touched[`${counts[index]?.toLowerCase()}_home_country`] && (
                                                                    <span className="input-error-msg">
                                                                        {formik.errors[`${counts[index]?.toLowerCase()}_home_country`]}
                                                                    </span>
                                                                )}
                                                            </div>
                                                        </div>
                                                ...
                                                <div className="form-div">
                                                    ...
                                                    <select
                                                        ...
                                                        className={`form-control ${formik.errors.num_of_children_under_18 ? "invalidInput" : ""
                                                            } `}
                                                        onChange={formik.handleChange}
                                                        onBlur={formik.handleBlur}
                                                ...
                                                <div className="form-div">
                                                    ...
                                                    <select
                                                        ...
                                                        id="other_dependants"
                                                        className={`form-control ${formik.errors.other_dependants && formik.touched.other_dependants ? "invalidInput" : ""
                                                            } `}
                                                        onChange={formik.handleChange}
                                                        onBlur={formik.handleBlur}
                                                ...
                                                {formik.values.other_dependants === "Yes" && (
                                                    ...
                                                    < div className="form-div">
                                                        ...
                                                        <input
                                                            ...
                                                            name="Partner"
                                                            id="Partner"
                                                            className={`form-control ${formik.errors.living_with_partner
                                                                ? "invalidInput"
                                                                : ""
                                                                } `}
                                                            placeholder=""
                                ...
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="Additional-box">
                                            ...
                                            {/* <form> */}
                                            <label htmlFor="forest_or_farmland_details">Other than domestic property, do you own any forest, farmland or other not attached to one of your properties? If so, please advise size and location.</label>
                                            <textarea id="forest_or_farmland_details" name="forest_or_farmland_details" rows="6" className="form-control" cols="50" onChange={formik.handleChange}
                                                onBlur={formik.handleBlur}
